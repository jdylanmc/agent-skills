...
Keep its evidence in that packet. Root delivery must execute DELIVERY's provider
promotion/readback gate; scoped workers return without claiming delivery.
