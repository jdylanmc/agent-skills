---
name: code-executive-summary
description: Compose the engineering-leadership executive summary of a code roast from frozen canonical technical details, without changing priority, omitting a must-fix, or adding a claim.
level: atom
allowed-tools: ["task"]
includes: []
composes: []
