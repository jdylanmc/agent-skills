---
name: code-evidence-scope
description: Define the read-only role, the bounded review scope, and the immutable evidence packet for a code roast, so every later step cites evidence that was staged and identified up front.
level: atom
