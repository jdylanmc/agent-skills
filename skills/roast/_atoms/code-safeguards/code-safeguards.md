---
name: code-safeguards
description: Define the safeguards, error handling, and named scenarios for a code roast, including untrusted-evidence handling, refusal behavior, and live-source revalidation.
level: atom
