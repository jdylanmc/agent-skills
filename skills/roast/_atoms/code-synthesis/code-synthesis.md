---
name: code-synthesis
description: Define The Roastmaster council coordination and the deterministic synthesis that verifies findings, rejects unsupported claims, and ranks recommendations for a code roast.
level: atom
allowed-tools: ["task"]
includes: []
composes: []
...
`skills/roast/references/bundled-roasters/the-roastmaster/`
