---
name: code-subagent-contract
description: Define the reviewer subagent prompt package and the common council report contract that every code roaster must satisfy.
level: atom
allowed-tools: ["task"]
includes: []
composes: []
