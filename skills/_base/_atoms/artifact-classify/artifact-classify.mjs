...
const ROUTES = {
  agent: 'roast-this-agent',
  skill: 'roast-this-skill',
  prompt: 'roast-this-prompt',
  code: 'roast-this-code',
};
...
function resultFromSignals(signals, locator) {
  ...
  return {
    ...
    locator,
    candidates: ['agent', 'skill', 'prompt', 'code'].map((type) => ({ type, routeToSkill: ROUTES[type] })),
