...
- **Dependency-aware fleet delivery (`ship-with-squadron`).** A new
  ...
  Integration, Roast, exact Pull Request 157 blast-radius proof, publication,
  ...
  replacement-safe token-owned lock directories, validates portable
  ...
  identity- and digest-bound handoffs before claiming timeout recovery.
