...
- **Price the future, not only the edit.** A fast patch that raises the cost of every later change is normally a losing trade. Within the authorized implementation scope, improve directly related surrounding code when the improvement is small, low-risk, and cheaper now than later.
